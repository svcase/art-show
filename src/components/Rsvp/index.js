...
const Rsvp = () => {
  ...
  return (
    <div className="rsvp">
      ...
      <a className="btn" href={`mailto:darlington.liza@gmail.com,lcreusch@gmail.com?subject=Garage Art Show RSVP&body=` + name + ` is attending the Garage Art Show with ` + guest + ` guest(s)!`}>RSVP</a>
    </div>
  );
}
